...
export function Body() {
  ...
  return (
    <div className="font-CD font flex flex-col md:w-[45rem] h-[25rem] sm:bg-[#151515] text-white items-center justify-center m-4 overflow-hidden rounded-lg">
      <div className="flex sm:flex-row flex-col justify-between items-center w-full md:mt-2 sm:h-1/3">
        ...
        <div className="md:ml-4 sm:mx-[3rem] text-[10px] sm:text-[15px] font-medium text-[#a9a5a5]">
          Get things done quickly with the help of Shūchū!
        </div>
      </div>
      <div className="bg-[#817c7c] w-full sm:h-1"></div>
      <div className="text-[100px] sm:text-[120px] font-bold sm:h-5/6 items-center flex justify-start">
        {formatTime(time)}
      </div>

      <div className="flex flex-row gap-4 sm:h-1/5 mb-10">
